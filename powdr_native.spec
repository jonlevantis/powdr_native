# powdr_native.spec — macOS, NO BUNDLE (assembled manually in workflow)
...
a = Analysis(
    ...
    datas=[
        ("app_qt.py", "."), ("afps.py", "."), ("fitting.py", "."),
        ("preprocessing.py", "."), ("plotting.py", "."),
        *qt_datas,
    ...
    hiddenimports=[
        *qt_hiddenimports,
        ...
        "scipy.optimize", "scipy.optimize._nnls", "scipy.interpolate",
...
exe = EXE(
    pyz, a.scripts, [],
    exclude_binaries=True, name="powdR",
...
coll = COLLECT(
    ...
    strip=False, upx=True, name="powdR",
)
